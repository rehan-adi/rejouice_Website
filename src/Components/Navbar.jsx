        ...
        {isOpen && (
          ...
          >
            <div className='flex flex-col justify-start items-start'>
              ...
              className=' w-96 rounded-lg mt-4 h-56 object-cover' autoPlay loop muted>
                <source src="/src/Components/Media/RJ-2.0-Video background .mp4" type="video/mp4" />
              </motion.video>
              <div className='flex gap-[245px] pt-3 items-center'>
                <motion.h1 
                className='text-black'> <IoMdPlayCircle className='inline-block mr-2 text-xl' />Play reel</motion.h1>
            ...
            <div className='text-black flex justify-center items-start flex-col h-[350px] pr-32 bg-[#FF5F38] rounded-md'>
              <ul className=''>
                ...
                exit={{y : -60, opacity : 0}}
                className='cursor-pointer text-5xl text-black'>Home</motion.li>
                <motion.li 
                 initial={{y : 60, opacity : 0}} 
                 animate={{y : 0, opacity: 1}}
                 transition={{duration: 0.50, delay: 0.20}}
                 exit={{y : -60, opacity : 0}}
                className='cursor-pointer text-5xl pt-[6px] text-black'>Contact</motion.li>
                <motion.li
                 initial={{y : 60, opacity : 0}} 
                 animate={{y : 0, opacity: 1}}
                 transition={{duration: 0.50, delay: 0.40}} 
                 exit={{y : -60, opacity : 0}}
                className='cursor-pointer pt-[6px] text-black text-5xl'>Work</motion.li>
                <motion.li
                 initial={{y : 60, opacity : 0}} 
                 animate={{y : 0, opacity: 1}}
                 transition={{duration: 0.50, delay: 0.60}} 
                 exit={{y : -60, opacity : 0}}
                className='cursor-pointer pt-[6px] text-black text-5xl'>Services & Models</motion.li>
              </ul>
              <motion.button
               initial={{y : 60, opacity : 0}} 
               animate={{y : 0, opacity: 1}}
               transition={{duration: 0.50, delay: 0.80}}  
               exit={{y : -60, opacity : 0}}
              className='px-8 py-3 mt-6 bg-transparent text-
              base border hover:bg-black hover:text-[#FF5F38] text-black text-opacity-90 border-black rounded-md'>Take a seat</motion.button>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
